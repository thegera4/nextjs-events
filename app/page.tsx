  ...
  return (
    <div className={styles.container}>
      <main className={styles.main}>
        <h1 className={styles.title}>How to use this application:</h1>
        <p>
          Welcome. This project is still being updated and improved, but for now you can register 
          a new user, login, logout, create events, edit events, delete events, view all events and filter them, and view the 
          details of a single event.
        </p> 
        <p>
          Some routes are protected (create/edit/delete), so you need to be logged in to try them. If you do not want to register a new user, you can use the following credentials to login:
        </p>
        <p>
          Email: <strong><span>test1@emai.com</span></strong><br/><br/>
          Password: <strong><span>test1@emai.com</span></strong>
        </p>
        <p>This Fullstack application is powered by the technologies mentioned below.</p>
